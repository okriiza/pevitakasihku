         ...
         <div class="card mb-5 p-4 bg-white shadow-sm">
            ...
            <div id="stepperForm" class="bs-stepper">
               ...
               <div class="bs-stepper-content">
                  <form method="post" id="register_form" action="<?php echo site_url('User/save_pelanggan_frontend') ?>" enctype="multipart/form-data">
                     <div id="test-form-1" role="tabpanel" class="bs-stepper-pane fade" aria-labelledby="stepperFormTrigger1">
                        <div class="form-group">
                           <input type="text" name="id" value="<?php print_r($nilai[0]["id"]); ?>" hidden>
                        ...
                        <div class="form-group">
                           ...
                           <input id="inputnotelepon" name="no_telepon" id="no_telepon" class="form-control no_telepon"  value="" required onkeypress="return hanyaAngka(event)" maxlength="14" data-validation="length alphanumeric" data-validation-length="10-14" data-validation-error-msg="Nomor Telepon harus berjumlah 10-14 karakter">
                        </div>
                     ...
                     <div id="test-form-2" role="tabpanel" class="bs-stepper-pane fade" aria-labelledby="stepperFormTrigger2">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="alamat" id="alamat" class="form-control alamat" maxlength="50" required data-validation="length" data-validation-length="3-50" data-validation-error-msg="Masukan alamat anda" value="">
                        </div>
                     ...
                     <div id="test-form-3" role="tabpanel" class="bs-stepper-pane fade" aria-labelledby="stepperFormTrigger3">
                        <div class="form-group">
                           ...
                           <input id="inputnama" name="nama_lengkap" id="nama_lengkap" type="text" class="form-control nama_lengkap" value="" maxlength="50" data-validation="length" required data-validation-length="3-50" data-validation-error-msg="Masukan nama lengkap anda">
                        </div>
                        <div class="form-group">
                           <label valign="top">Nomor Handphone <span class="text-danger font-weight-bold">*</span></label>
                           <input type="text" name="no_handphone" id="no_handphone" class="form-control no_handphone" value="" required onkeypress="return hanyaAngka(event)" maxlength="14" data-validation="length alphanumeric" data-validation-length="10-14" data-validation-error-msg="Nomor Handphone harus berjumlah 10-14 karakter" >
                        </div>
                        <div class="form-group">
                           <label valign="top">Email <span class="text-danger font-weight-bold">*</span></label>
                           <input type="text" name="email" id="email" class="form-control email" value="" required data-validation="email" data-validation-error-msg="Anda belum memberikan alamat email yang benar">
                        </div>
                        <div class="form-group">
                           ...
                           <option value="<?php echo $row->id;?>"><?php echo $row->nama_pekerjaan ;?></option>
                           <?php endforeach;?>
                           </select>
                        </div>
                    <div class="form-group">
                        ...
                        type="text" name="no_ktp" placeholder="" required maxlength="16" data-validation="length alphanumeric" data-validation-length="16" data-validation-error-msg="Nomor KTP harus berjumlah 16 karakter" value="<?php echo $this->session->userdata('no_ktp') ;?>">
                     </div>
                   <div class="form-group">
                        <label valign="top">Upload KTP</label>
